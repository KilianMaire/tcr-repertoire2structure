...
_HARDENED_FOLD = _code(
    ...
    "\n",
    "SMOKE = False       # False: fold the whole batch (server-free MSA confirmed: the log\n",
    "                    # shows 'do not need to update msa result', no MSA server). Set True\n",
    "                    # to fold only the first construct as a cheap live re-check.\n",
