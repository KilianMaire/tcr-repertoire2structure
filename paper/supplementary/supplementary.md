...
A*11:01 epitope (AVFDRKSDAK), coloured by chain. The pipeline produces consistent
well-folded complexes across epitopes and both alleles, not a single cherry-picked
fold. Renders from `scripts/render_structure_pymol.py`.
